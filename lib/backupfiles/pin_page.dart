  ...
  Widget Delebut() {
    return InkWell(
      onTap: () {
        setState(() {
          if(Password[5]!="_"){
            Password = Password.replaceRange(5, 6, "_");
          }else if(Password[4]!="_"){
            Password = Password.replaceRange(4, 5, "_");
          }else if(Password[3]!="_"){
            Password = Password.replaceRange(3, 4, "_");
          }else if(Password[2]!="_"){
            Password = Password.replaceRange(2, 3, "_");
          }else if(Password[1]!="_"){
            Password = Password.replaceRange(1, 2, "_");
          }else if(Password[0]!="_"){
            Password = Password.replaceRange(0, 1, "_");
          }
        });
      },
      child: Padding(
